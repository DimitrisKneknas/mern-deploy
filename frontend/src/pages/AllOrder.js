...
import displayGreekCurrency from '../helpers/displayCurrency'
            ...
            <div className='p-4 w-full'>
                {
                    data.map((item, index) => {
                        return (
                            <div key={item.userId + index} style={{ marginBottom: '2rem' }}>
                                ...
                                <div className='border rounded p-2'>
                                                        ...
                                                        <div key={product.productId + index} className='flex gap-3 bg-slate-100'>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className='flex items-center gap-5 mt-1'>
                                                                    <div className='text-lg text-red-500'>{displayGreekCurrency(product.price)}</div>
                                    ...
                                    <div className='font-semibold ml-auto w-fit lg:text-lg'>
                                        Total Amount: {displayGreekCurrency(item.totalAmount)}
                                    </div>
                                </div>
                            </div>
                        )
